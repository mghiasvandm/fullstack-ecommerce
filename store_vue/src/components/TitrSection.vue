<template>
   <div class="flex items-center flex-row titr-section">
     <svg style="transform: rotate(178deg);margin-right: 2%" class="ml-3 fill-sky-600" width="24px" height="24px" viewBox="0 0 100 100" id="Layer_1" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g>
               <g id="fill">
     ...
     <h1 class="text-2xl font-bold text-right my-10 mr-5 text-black " style="margin-right: 0%;">{{title}}</h1>
